...
public class canPedido extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(canPedido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        public void actionPerformed(ActionEvent e){
            if(id.getText().equals("")){
                ...
                try {
                    ...
                    Logger.getLogger(canPedido.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
    });
